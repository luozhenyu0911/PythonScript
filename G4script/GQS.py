...
subprocess.call(["bedtools","getfasta","-fi","/gss1/home/zqq20190923/reference/rice/rice7.fa","-bed",sys.argv[1]],stdout=fa)
...
for i in range(0,100):
    ...
    subprocess.call(["bedtools","getfasta","-fi","/gss1/home/zqq20190923/reference/rice/rice7.fa","-bed",str(sys.argv[1].split(".")[0]+sys.argv[2]+"tmp.bed")],stdout=tmpfa)
