...
example_text = '''example:
 2020.6.14
 python **.py --referencePoint start/end -b CGmap.gz,... -G **.bed,**.bed... -L bamlabel1,bamlabel2 -l bedlabel1,bedlabel2 --Facet Bam/Bed -u 1000 -d 1000 -w 50 -o average.data,matrix.data -f figure.pdf
 python **.py --scaleRegion -b CGmap.gz,... -G **.bed,**.bed... -L bamlabel1,bamlabel2 -l bedlabel1,bedlabel2 --Facet Bam/Bed -u 1000 -d 1000 -w 50 -N 100 -o average.data,matrix.data -f figure.pdf
'''
...
if referencePoint:
    ...
    if referencePoint=="start":
        ...
        out_matrix=open(outf+'.fullmat',"w")
