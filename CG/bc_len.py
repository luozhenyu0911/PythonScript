...
print("bc_id","fragment_len","denovo_len","ratio","Nreads",file=output)
...
#     print(line)
    ...
    tmp_id,denovo_len=get_tatal_len(filename)
    if denovo_len >= actual_len:
        # print(bc_id,actual_len,denovo_len,"1",*lines,sep='\t')
        print(bc_id,actual_len,denovo_len,"1",args.bc_list,sep='\t',file=output)
    else:
        rate=denovo_len/actual_len
        # print(bc_id,actual_len,denovo_len,rate,*lines,sep='\t')
        print(bc_id,actual_len,denovo_len,rate,args.bc_list,sep='\t',file=output)
