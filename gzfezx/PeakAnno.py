...
def message():
    ...
    print("\n"+"Usage: python PeakAnno.py [options]"+"\n")
    ...
    print("\t"+"python PeakAnno.py -d /BIGDATA2/gzfezx_shhli_2/database/GRCh38/GRCh38_gff.db -b input.bed -a prefix_peakanno.txt -p prefix_peakannosum.txt -l prefix -o prefix_peakanno.pdf"+"\n")
...
opts,args = getopt.getopt(sys.argv[1:],'-h-v-d:-b:-a:-p:-o:-l:',['help','version'])
for opt_name,opt_value in opts:
    ...
    if opt_name not in ('-h,-v,-d,-b,-a,-p,-o,-l'):
        pass
Option={}
for option in opts:
...
if len(Option) > 1:
    subprocess.call(["/WORK/gzfezx_shhli_3/BioSoftware/anaconda/3/envs/R4.3.1/bin/Rscript","/BIGDATA2/gzfezx_shhli_2/USER/luozhenyu/script/script/gzfezx/peakanno_for_ggplot2.r",Db,bed,annotationtxt,percentfile,title,figure])
elif len(Option) <1:
    message()
# else:
#     pass
