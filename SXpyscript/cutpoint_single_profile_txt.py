...
def message():
    ...
    print("\t"+"-G"+"    <bed list text file>"+"\t"+"data files(A text file containing bed file name per line.), should be original bed files.")
    ...
    print("\t"+"-l"+"    <legend names>"+"\t"+"A text file containing Name of the plot legend per line. (Support for multiple legends)")
...
for opt_name,opt_value in opts:
    ...
    if opt_name in ('-l'):
        ...
        legendname=[]
        with open(legend,'r') as legendtxt:
