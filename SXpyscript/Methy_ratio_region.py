...
#read methylation level of each base of CGmap file, save as a dict.
...
#divide into 3 parts, upstream body and downstream
...
if "--grouprev" in allopt:
    if '-B' in allopt:
        ...
        for line2 in bamlist:
            bamdir=line2.rstrip()
            genevalues=bamtocount(bedpos,bamdir,step_f,strands,Bnum)
